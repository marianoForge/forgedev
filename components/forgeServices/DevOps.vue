<template>
  <div class="w-full lg:w-4/12 text-center mt-20">
    <div class="flex service--wrapper flex-column z-10" data-aos="fade-up">
      ...
      <div class="service--info__wrapper" style="width:400px" ;>
        ...
        <img src="~/assets/images/forge-devops.svg" class="mx-auto shadow-svg w-32" alt="Devops" />
        <div class="service--info__on mt-10 pt-2">
