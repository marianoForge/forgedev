<template>
  <div class="w-full lg:w-4/12 text-center mt-20 pr-40">
    <div class="flex service--wrapper flex-column z-10" data-aos="fade-up">
      ...
      <div class="service--info__wrapper" style="width:400px" ;>
        ...
        <img src="~/assets/images/forge-qa.svg" class="mx-auto shadow-svg w-32 pb-6" alt="QA" />
        <div class="service--info__on mt-4">
