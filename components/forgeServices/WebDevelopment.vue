<template>
  <div class="w-full lg:w-4/12 mt-5 text-center">
    <div class="flex service--wrapper flex-column z-10" data-aos="fade-up">
      ...
      <div class="service--info__wrapper" style="width:400px" ;>
        ...
        <img
          ...
          class="mx-auto shadow-svg w-40 pt-8"
          alt="Web Development"
        />
        <div class="service--info__on mt-16">
          ...
          <p class="pt-4">
            <a href="#" class="pt-4" style="color: #1bcac4">Learn More ></a>
          </p>
        </div>
      </div>
    </div>
